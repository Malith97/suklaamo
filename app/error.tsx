  ...
  return (
    <main className="min-h-screen bg-background text-text-dark">
      <section className="container mx-auto py-24 text-center">
        <p className="text-sm uppercase tracking-[0.35em] text-accent-cocoa">{locale === 'fi' ? 'Jokin meni pieleen' : 'Something went wrong'}</p>
        <h1 className="mt-4 text-5xl font-black text-primary">{locale === 'fi' ? 'Hups, tapahtui virhe' : 'Oops, an error occurred'}</h1>
        <p className="mx-auto mt-6 max-w-xl text-base leading-8 text-[#5a4030]">
          {locale === 'fi' ? 'Pahoittelemme keskeytystä. Päivitä sivu tai palaa etusivulle ja jatka Suklaamoon tutustumista.' : 'We&apos;re sorry for the interruption. Please refresh the page or return home to continue exploring Suklaamo.'}
        </p>
