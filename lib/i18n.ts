...
const translations = {
  en: {
    ...
    common: { browseCatalogue: 'Tutustu valikoimaan', continueShopping: 'Jatka ostoksia', backHome: 'Takaisin etusivulle', backToCatalogue: 'Takaisin valikoimaan', order: 'Tilaa', pickupDetails: 'Noutotiedot', productDetails: 'Tuotetiedot', ingredients: 'Ainesosat', freshBatch: 'Tuore erä', madeToOrder: 'Tilauksesta valmistettava', each: 'kpl', items: 'tuotetta', item: 'tuote', total: 'Yhteensä', subtotal: 'Välisummaa', delivery: 'Toimitus', vat: 'ALV', remove: 'Poista', clearCart: 'Tyhjennä ostoskori', continueToCheckout: 'Jatka kassalle', addToCart: 'Lisää ostoskoriin', orderLimitReached: 'Tilausraja saavutettu', clickToViewMore: 'Katso lisää', close: 'Sulje', viewPolicies: 'Näytä ehdot', submitting: 'Lähetetään...', sendRequest: 'Lähetä pyyntö', sending: 'Lähetetään...' },
